                ...
                <div id="cartL_topD">
                    {(!authState) ?
                        <small id="cartLTopD_emptyMsg">
                            ...
                            <SignUpWindow setAuthState={setAuthState} buttonLabel={"Join us"} className={"modal-dialog modal-md"} />
                            or
                            <SignInWindow setAuthState={setAuthState} buttonLabel={"SignIn"} className={"modal-dialog modal-md"} />
                        </small>
                        :
